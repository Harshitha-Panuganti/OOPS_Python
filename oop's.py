...
# Polymorphism-(Polymorphism means having many forms same function name but used
# for differnt types)
# class Parrot:
#     def fly(self):
...
#Encapsulation - (Encapsulation is one of the cornerstone concepts of OOP. The basic idea of Encapsulation is to wrap up 
# both data and methods into one single unit.)

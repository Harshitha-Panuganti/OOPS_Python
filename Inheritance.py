# Single inheritance
# In this type of inheritance, there is a single derived class from a
# single base class
# class HomoSapiens:
#     def speak(self):
...
# In Multiple inheritance, the derived class inherited from more 
# than one base class
# class Claculation1:
#     def sum(self,x,y):
#         return x+y; 
...
# If more than one class is inherited from base class then 
